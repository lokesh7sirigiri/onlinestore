...
import com.dummy.myapp.domain.ProductOrder;
import com.dummy.myapp.repository.ProductOrderRepository;
import com.dummy.myapp.service.ProductOrderService;
...
/**
 * REST controller for managing {@link com.dummy.myapp.domain.ProductOrder}.
 */
@RestController
@RequestMapping("/api")
